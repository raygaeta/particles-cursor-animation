...
displacement.glowImage.src = './ripple.png'

// Interactive plane
displacement.interactivePlane = new THREE.Mesh(
    new THREE.PlaneGeometry(10, 10),
    new THREE.MeshBasicMaterial({ color: 'red', side: THREE.DoubleSide, wireframe: false })
)
...
const particlesMaterial = new THREE.ShaderMaterial({
    ...
    uniforms:
    {
        uResolution: new THREE.Uniform(
            new THREE.Vector2(sizes.width * sizes.pixelRatio, 
...
const tick = () =>
{
    ...
    particlesMaterial.uniforms.uTime.value += deltaTime
    ...
    if(intersections.length)
        {
            ...
            // Adjust for rotation
            const angle = -particles.rotation.z; // Reverse the rotation
            ...
            displacement.canvasCursor.x = (rotatedX + 0.5) * displacement.canvas.width;
            displacement.canvasCursor.y = (1 - (rotatedY + 0.5)) * displacement.canvas.height;
        }
